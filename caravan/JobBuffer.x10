...
class JobBuffer {
  ...
  def saveResults( results: Rail[JobConsumer.RunResult], consPlace: Place ) {
  ...
  private def asyncSendResultsToProducer() {
    ...
    val results: ArrayList[JobConsumer.RunResult] = new ArrayList[JobConsumer.RunResult]();
